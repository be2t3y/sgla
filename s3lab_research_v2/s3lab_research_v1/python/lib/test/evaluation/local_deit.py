...
def local_env_settings():
    ...
    settings.network_path = f'{_S3PY}/output/test/networks'
    settings.nfs_path = f'{_DATA}/nfs'
    settings.otb_path = f'{_DATA}/otb'
    settings.prj_dir = _S3PY
    settings.result_plot_path = f'{_S3PY}/output/test/result_plots'
    settings.results_path = f'{_S3PY}/output/test/tracking_results'
    settings.save_dir = f'{_S3PY}/output'
    settings.segmentation_path = f'{_S3PY}/output/test/segmentation_results'
